...
public:
    ...
    void drawCubeWithMaterialisticProperty(Shader& lightingShader, glm::mat4 model = glm::mat4(1.0f), float a=1.0)
    {
        lightingShader.use();
        ...
        lightingShader.setFloat("material.opacity", a);
    ...
    void drawCube(Shader& shader, glm::mat4 model = glm::mat4(1.0f), float r = 1.0f, float g = 1.0f, float b = 1.0f, float a= 1.0f)
    {
        shader.use();
...
private:
    ...
    void setUpCubeVertexDataAndConfigureVertexAttribute()
    {
        ...
        glGenVertexArrays(1, &lightTexCubeVAO); //for texture
